<%@ page import="Class.Public_Variable" contentType="text/html;charset=UTF-8" language="java" %>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
<html>
<head>
    <title>优先级算法</title>
    <link href="http://localhost:8080/Curriculum_Design/CSS/PPRIORITY.css" rel="stylesheet" type="text/css">
</head>
<body>
    <div class="father1">
        <div class="indexbtn">
    ...
    <div class="container" style="display: flex">
        <div class="input" style="position: relative;width: 600px;height: 300px">
            <form action="/Curriculum_Design/PPRIORITYServlet" method="POST">
                <label>进 程 名 :</label>
            ...
            <table border="1">
                ...
                <c:forEach var="process1" items="${process1}">
                    <tr>
                        ...
                        <td style="text-align: center">${process1.priority}</td>
                    </tr>
                </c:forEach>
            </table>
        </div>
