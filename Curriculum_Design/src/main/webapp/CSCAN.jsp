...
<div class="container">
  <div class="top-left">
    ...
    <div class="head2">
      <form action="CSCANServlet" method="post" style="margin-left: 10px">
        <input type="submit" value="初始化" name="s3"
             class="button-intial">
      </form>

      <form action="CSCANServlet"  method="post" style="margin-left: 20px">
    ...
    <div class="head3">
      ...
      <form action="CSCANServlet" method="post" style="margin-left: 118px">
