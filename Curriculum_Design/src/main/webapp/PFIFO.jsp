<%@ page import="Class.Public_Variable" language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
...
<head>
    <title>先进先出算法</title>
    <link href="CSS/PFIFO.css" rel="stylesheet" type="text/css">
</head>
<body>
    <div class="father1">
        <div class="indexbtn">
    ...
    <div class="container" style="display: flex">
        <div class="input" style="position: relative;width: 600px;height: 250px">
            <form action="/Curriculum_Design/PFIFOServlet" method="POST">
                <label>进 程 名 :</label>
        ...
        <div class="out" style="position: relative;width: 600px;height: 245px;right: -175px">
