...
<div class="container">
    ...
    <div class="top-left">
        ...
        <div class="head2">
            <form action="FCFS" method="post" style="margin-left: 10px">
                <input type="submit" value="初始化" name="s3"
                       class="button-intial">
            </form>

            <form action="FCFS"  method="post" style="margin-left: 20px">
                <strong   style="color:black">磁头初始位置:</strong>
                <input type="number" min="0" step="1" name="firstNum" value="${firstNum}">
                <input type="submit" value="确认" name="s4" class="button-intial" style="margin-left: 20px;">
            </form>
        </div>
        ...
        <div class="head3">
            ...
            <form action="FCFS" method="post" style="margin-left: 118px">
